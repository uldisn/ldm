    ...
    */
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'planed_delivery_type' => Yii::t('LdmModule.model', 'Planed delivery type'),
            'groupage' => Yii::t('LdmModule.model', 'Groupage'),
            'planed_dispatch_date' => Yii::t('LdmModule.model', 'Planed dispath date'),
            'planed_delivery_date' => Yii::t('LdmModule.model', 'Planed delivery date'),
